...
export const initiateSSLCommerzPayment = async (orderData: any) => {
    try {
        ...
        const data = {
            ...
            currency: 'BDT',
            tran_id,
            success_url: `${config.frontendUrl}/payment/success/${tran_id}`,
            fail_url: `${config.frontendUrl}/payment/failed/${tran_id}`,
            cancel_url: `${config.frontendUrl}/payment/cancel/${tran_id}`,
